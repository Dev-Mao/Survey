  ...
  return (
    <div className={styles.resultsContainer}>
      ...
      {props.points >= 0 && props.points < 4 ? (
        <>
          <img className={styles.imgResult} src="https://i.pinimg.com/1200x/3f/87/c5/3f87c5b2a2e06bfaf5d37d974f607a02.jpg" alt="resultado" />
          <p>
            Déjame decirte que no estás preparado/a para sobrevivir ni un solo día
            en el apocalipsis zombi, eres carnaza de zombi. Si tienes mucha
        ...
        <>
          <img className={styles.imgResult} src="https://yt3.ggpht.com/vzjvmKClbsUqTxY8IpcO8DBPY9Pn10NJcxq1IyoQbZ0qbdccDWQXQJPWlnOcoEFIVNrJrbNVkndrzw=s640-nd-v1" alt="resultado" />
          <p>
        ...
        <>
          <img className={styles.imgResult} src="https://victoraqui.com/wp-content/uploads/2022/08/5a3a9acec78c0.jpg" alt="resultado" />
          <p>
